...
Geom: `geom_jitter`. Marks: the coloured dots. Mappings: `ph → x`, `nugent_score → y`, `arm → color`.
...
#| fig-width: 4
#| fig-height: 2.8
ggplot(table_02, aes(arm, nugent_score, color = ph)) +
...
#| fig-width: 4
#| fig-height: 2.8
ggplot(table_02, aes(ph, crp_blood)) +
  geom_point(color = "navyblue") +
...
#| fig-width: 4
#| fig-height: 2.8
ggplot(table_02, aes(arm, ph, fill = arm)) +
  geom_boxplot() +
