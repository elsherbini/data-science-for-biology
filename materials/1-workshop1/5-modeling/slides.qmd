...
- **Response $y$**: Who does (1) or doesn't (2) get infected during an outbreak?
...
- In the Bernoulli example, the way infection probability increases with social contact may vary from county due to unmeasured factors, like population density.
