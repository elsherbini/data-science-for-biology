# VS Code tour screenshot sources

Screenshots used in the Module 2 VS Code tour. Each was downloaded from the
page listed below. Attribution footers on the slides link back to these pages.

| File | Source page | Image URL |
|------|-------------|-----------|
...
The Quarto documentation is published under CC BY (https://github.com/quarto-dev/quarto-web).
The VS Code documentation is published by Microsoft under CC BY 4.0
