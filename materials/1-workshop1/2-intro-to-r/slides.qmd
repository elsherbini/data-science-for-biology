...
Join the Discord server: [https://discord.gg/zSBTQ9ctt](https://discord.gg/zSBTQ9ctt)

![](../0-welcome/images/discord_durban.png){fig-alt="Screenshot of the discord server app that serves as the forum for the workshop." fig-align="center" width="546"}
...
::: {.column width="52%"}
![](images/vscode-tour/vscode-userinterface-hero.png){fig-alt="A VS Code window labelling the Editor in the center, the Side Bar and Activity Bar on the left, and the Status Bar along the bottom." width="100%"}
:::

::::

::: footer
Screenshot from the [VS Code user interface documentation](https://code.visualstudio.com/docs/getstarted/userinterface).
:::
...
- **Be specific about goal and inputs.**
  "Read `02_visit_clinical_measurements.csv` and show me the mean `nugent_score` by arm" beats "look at the data."
