...
The terminal is a command line built into the window. You type commands here, and this is where Claude Code runs.
...
This is handy when Claude Code is running in one terminal and you want another for your own commands.
...
Open one from the Explorer and it appears in the editor. You can edit the plain-text source directly, or switch to the visual editor for a word-processor-style view. The two are the same file -- changes in one show up in the other.
...
You can also ask Claude Code, the AI assistant from Module 1. It is good at explaining what a function does and suggesting how to call it. Treat its answers as a starting point and check them against the help page, since it is not always correct.
