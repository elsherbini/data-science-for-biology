...
```
 ...
 <font size="16"> Analysis</font>  
 
 <font size="6"> Step 1: Set up a new RMarkdwon document </font> 

 <font size="6"> Step 2: Initiate your environment </font> 
...
```
 ...
 <font size="6"> Step 3: Set the location and load our input files  </font> 
...
<font size="6"> step 4: Merging our metadata with our data table </font> 
...
```
 ...
 <font size="6"> Step 5: Preliminary bigtable plots </font> 
...
<font size="6"> Step 6: Filtering Strategies </font> 
...
**Task: Filter your raw viral hits to only keep protein hits with an evalue < 1e-10**
 ...
 <font size="6"> Step 7: Analyse taxon counts </font> 
...
<font size="6"> Step 8: Statistical tests </font> 
...
```
 ...
 <font size="6"> Step 9: Contig based analysis </font> 
